...
Awhile back I decided to start using [Springpad](https://www.springpad.com/) for bookmarking and notes. It's worked out pretty well so far.

Springpad has various ways of saving stuff; e.g. browser extensions, a bookmark-let, email but I was looking a way to feed stuff from [Reader](https://reader.google.com/) (which I love); i.e. without opening a new window, waiting for the page to load and then finally using either the extension or bookmark-let to save it to Springpad. It's just so... slow.
...
![Google Reader to Springpad](/2013-01-google-reader-to-springpad.jpg)
