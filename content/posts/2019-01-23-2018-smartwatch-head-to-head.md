...
From my use of the Withings device, the data makes its way into _Health Mate_, and optionally, _Health_. Eventually, said data is transferred to a Withing's server(s); e.g., there are online dashboard(s), plus [there is an API](http://oauth.withings.com/oauth2/).
