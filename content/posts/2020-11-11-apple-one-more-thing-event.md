...
![M1 overview](/2020-11-11-m1-overview.png)

8-core CPU: 4 performance/efficiency cores each:

![CPU performance vs. power](/2020-11-11-cpu-performance-vs-power.png)

This performance gulf seems to be the case for graphics as well, with an (up to) 8-core GPU.

![GPU performance vs. power](/2020-11-11-gpu-performance-vs.power.png)

Also, there's a 16-core Neural Engine.

On security:

![Security](/2020-11-11-m1-security.png)
...
![MacBook Air](/2020-11-11-macbook-air-overview.png)
