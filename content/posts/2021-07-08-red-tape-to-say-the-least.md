...
My family [wrote in](https://webform-sto.plexure.com.sg/) to ~~complain~~ feedback about our inability to select a date -- any entry date, for that matter -- when applying for our incoming domestic helper to serve her [stay home notice](https://safetravel.ica.gov.sg/health/shn/sdf).

Here's an except of the response (from [do-not-reply@safetravel.sg](mailto:do-not-reply@safetravel.sg)), **emphasis** mine:
...
Of course, we're in the middle of a pandemic here: we've struggled to be as patient and understanding as we can. In view of [our current context](#context), surely something's gotta give.

## Email #2

And so we responded, and here's an except of the subsequent response (from [mom_wpd@mom.gov.sg](mailto:mom_wpd@mom.gov.sg)), **emphasis** mine:
...
Our incumbent helper, S, has been with us for almost 3 years, overlapping with the awful [circuit breaker and the subsequent phases here in Singapore](https://en.wikipedia.org/wiki/2020%E2%80%9321_Singapore_circuit_breaker_measures). Our entire family have benefited directly from S's time and effort, we wouldn't have managed as well as we did if not for her.
