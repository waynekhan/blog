...
At the same time, I use iCloud Photos; I don't want a company to one day determine that a CSAM-scanning algorithm, however must run on my own iPhone, no sir. My personal protest has been to sign [An Open Letter Against Apple's Privacy-Invasive Content Scanning Technology](https://appleprivacyletter.com/), and avoid owning any Apple hardware running those impacted versions (iOS 15, iPadOS 15, watchOS 8, macOS Monterey), be it existing devices I own and control, as well as any new devices come September or later.
